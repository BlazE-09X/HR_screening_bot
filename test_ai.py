...
qa_pairs = [
    ...
    ("Расскажите о вашем последнем опыте работы.",
    ...
    ("Опишите ситуацию, когда у вас возник конфликт на работе. Как вы его решили?",
     "Был спор с коллегой из-за распределения задач, обсудили спокойно и договорились."),
    ("Предпочитаете работать в команде или самостоятельно? Почему?",
